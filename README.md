...
### A lightweight ledger for tracking client outcomes after Volta projects ship.
...
**Impact Metrics Ledger** is a polished, local-first open-source tool from Volta's open-source program. It helps Volta leadership, chapter leads, and enterprise partners turn real community work into structured evidence, client-safe handoffs, and mentor-reviewable release packets.
...
Nonprofits struggle to convert project activity into credible, funder-ready impact evidence.

### The niche

Student-powered service nonprofits reporting community impact.

### North-star metric

`verified outcomes collected after project handoff`
...
flowchart TD
    ...
    Evidence --> Workbench["Impact Metrics Ledger"]
    Workbench --> Score["Funding readiness"]
    Score --> Cert["release certification"]
    Cert --> A1["CSR summary"]
    Cert --> A2["Anonymized impact CSV"]
    Cert --> A3["Chapter dashboard JSON"]
...
flowchart LR
    subgraph Modules["First-class modules"]
        M1["Outcome definitions"]
        M2["90-day follow-up tracker"]
        M3["Evidence attachments"]
        M4["CSR summary export"]
    end
    M1 --> Workbench
    M2 --> Workbench
    M3 --> Workbench
...
sequenceDiagram
    ...
    participant T as Impact Metrics Ledger
...
|---|---|
| **Domain workbench** | A purpose-built impact ledger interface for a lightweight ledger for tracking client outcomes after volta projects ship. |
...
|---:|---|---|
| 1 | **Outcome definitions** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 2 | **90-day follow-up tracker** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 3 | **Evidence attachments** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 4 | **CSR summary export** | Converts field work into repeatable, reviewable Volta delivery evidence. |
...
This release adds a SaaS-grade operating layer so **Impact Metrics Ledger** can stand alone as more than a checklist. It models:
