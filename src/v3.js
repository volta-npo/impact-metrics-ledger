export const v3 = {
    ...
    "capabilities": [
        "Domain-specific workbench: Impact Metrics Ledger",
        "Operational table: Outcome records",
    ...
    "releaseChecklist": [
        ...
        "Verified Impact reaches production threshold",
        "Follow-up Coverage is documented with evidence",
        "CSR Readiness has no unresolved blocker",
        "CSR summary verified",
        "Anonymized impact CSV verified",
        "Chapter dashboard JSON verified"
    ],
    "operations": [
